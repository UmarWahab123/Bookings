                            ...
                            <table cellspacing="0" cellpadding="0" border="0">
                                <tbody><tr>
                                    <td>
                                        ...
                                        <span class="hsb-chd-font">Child X {{$data['child']}}</span>
                                    </td>
                                </tr>
                            </tbody></table>
                        </div>
    ...
    <div class="htl-sch-form-bd">
        ...
        <div class="row clearfix" class="checkIn-from">
            ...
            <div class="htl-sch-item sm first">
                ...
                <select id="Sch_cityCode" name="Sch_cityCode" class="sel htl-sch-sel" title=""><option value="21421" type="1" arrivalport="BQH">Biggin Hill</option><option value="575" type="1" arrivalport="BHX">Birmingham</option><option value="21418" type="1" arrivalport="BRS">Bristol</option><option value="182524" selected="selected" type="1" arrivalport="BZZ">{{$data['travel_to']}}</option><option value="21415" type="1" arrivalport="FAB">Farnborough</option><option value="6053770" type="1" arrivalport="LCY">London City</option><option value="182523" type="1" arrivalport="LGW">London Gatwick</option><option value="21414" type="1" arrivalport="LHR">London Heathrow</option>
            ...
            <div class="row clearfix" id="htl_sch_row3">
                ...
                <div class="htl-sch-item lg">
                    ...
                    <div>
                        ...
                        <select id="HtlSch_adultQty" name="HtlSch_adultQty" class="sel htl-sch-sel" title=""><option value="{{$data['adult']}}" selected="selected" >{{$data['adult']}}</option><option value="2" >2</option><option value="3" >3</option><option value="4" >4</option><option value="5" >5</option><option value="6" >6</option><option value="7" >7</option><option value="8" >8</option><option value="9" >9</option><option value="10" >10</option></select>
                ...
                <div class="htl-sch-item lg">
                    ...
                    <div>
                        ...
                        <select id="HtlSch_childQty" name="HtlSch_childQty" class="sel htl-sch-sel" title=""><option value="{{$data['child']}}" selected="selected" >2</option><option value="1" >1</option><option value="2" >2</option><option value="3" >3</option><option value="4" >4</option><option value="5" >5</option><option value="6" >6</option><option value="7" >7</option><option value="8" >8</option><option value="9" >9</option><option value="10" >10</option></select>
                ...
                <div class="htl-sch-item lg">
                    ...
                    <div>
                        ...
                        <select id="HtlSch_roomQty" name="HtlSch_roomQty" class="sel htl-sch-sel" title=""><option value="{{$data['room']}}" selected="selected" >{{$data['room']}}</option></select>
...
<div class="dv-age-item age1"><span class="span-age-title">Child 1</span><span class="span-age-sel">

<select data-option-id="{{$data['child1_age']}}" id="age_0" name="age_0" class="sel sch-sel-small" title="" required="1"><option value="-1" selected="selected">-?-</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option>

</select>

</span></div><div class="dv-age-item age2"><span class="span-age-title">Child 2</span><span class="span-age-sel">

<select data-option-id="{{$data['child2_age']}}" id="age_1" name="age_1" class="sel sch-sel-small" title="" required="1"><option value="-1" selected="selected">-?-</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option>
...
<p>
    ...
    If you require more than 1 room or if there are more than 2 children <strong>of any age</strong> in your party please email our team on familybookings@alpinetravels.co.uk
                    ...
                    <table>
                        ...
                        <tbody><tr>
                            ...
                            <td>
                              ...
                              <!--   <img alt="loading" src="../Themes/skin-1/images/hotel/loading-more.gif" width="20" height="20"></td> -->
...
The package includes food and beverages, transfers, security and two Covid tests
                ...
                <div class="col3">
                    ...
                    <div class="htl-rate-detail">
                        ...
                        <div class="htl-r-detail-sub">
                            ...
                            <div class="htl-rate-price">£{{number_format($data['price'])}}</div>
                ...
                <div class="col4">
                 ...
                 <form id="book2" action="{{ url('/book-now') }}" method="GET">
...
The package includes food and beverages, transfers, security and two Covid tests
                ...
                <div class="response-l1-r">
                     ...
                     <div>
                        ...
                        <input type="button" value="Book" class="htl-rate-book-btn js-GoToBookingPage btnbook" data-group-id="23747" data-rate-id="1">
            ...
            <div id="htl-rate-rule" class="htl-rate-rule" style="display: block;"><div>Please read and accept full <a class="color-red" target="_blank" href="{{url('/terms')}}">terms and conditions</a> before booking.<br>

 You must have a confirmed booking prior to travel to the UK.</div></div>
