         ...
         <div id="header_container" class="header_container">
            <div id="top_nav">
               <div class="container clearfix">
                  <div id="top_nav_l">
                     <a href="https://quarantinehotels.ctmportal.co.uk/">
                        <ul class="clearfix">
            ...
            <div class="htl-sch-page-sub">
               <div class="htl-book-complete-dv">
                  ...
                  <div class="htl-book-complete-msg">
                     <p>
                        We have received your inquiry. Thank you for choosing us. We'll get back to you soon.
                     </p>
                     <div class="htl-book-complete-sch">
                        <a href="{{url('/')}}" class="pointer color-white">Continue browsing</a>
                     </div>
                  </div>
               </div>
            </div>
