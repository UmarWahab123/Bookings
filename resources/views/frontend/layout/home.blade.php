                     ...
                     <div class="row clearfix" class="checkIn-from">
                        ...
                        <div class="htl-sch-item sm first">
                           ...
                           <select id="Sch_cityCode" name="Sch_cityCode" class="sel htl-sch-sel" title="">
                              ...
                              <option value="182524" type="1" arrivalport="BZZ">Brize Norton</option>
                     ...
                     <div class="dv-age-details clearfix" id="dv-age-details" isshow="1" style="">
                        ...
                        <div class="dv-age-item">
                           ...
                           <span class="span-age-sel">
                              <select id="age_0" name="age_0" class="sel sch-sel-small" title="" required="1">
                        ...
                        <div class="dv-age-item">
                           ...
                           <span class="span-age-sel">
                              <select id="age_1" name="age_1" class="sel sch-sel-small" title="" required="1">
                                 <option value="-1" selected="selected">-?-</option>
                                 <option value="5">5</option>
                                 <option value="6">6</option>
                                 <option value="7">7</option>
