            ...
            <div class="htl-sch-page-sub" id="htl-bkg-container">
               <div class="m-hide">
                  <div class="htl-bkg-bpb-container">
                     ...
                     <span class="fl pointer" onclick="window.location='../Hotel/Home.aspx';">/ Hotel</span>
                  </div>
                  <div class="clear"></div>
               ...
               <div class="htl-booking-dv clearfix">
                     ...
                     <div class="htl-b-content clearfix">
                        ...
                        <div class="htl-b-price-dv">
                           <div class="htl-b-price-title clearfix">
                              ...
                              <div class="col2">
                                 £{{$data['price']}} X 1 Room = £{{$data['price']}}
                           ...
                           <div class="htl-b-total-dv clearfix">
                              ...
                              <div id="total-price-show" class="routing-total-price">£{{$data['price']}}</div>
                                 ...
                                 <div class="clearfix">
                                    ...
                                    <div class="col">
                                       ...
                                       <div class="booking-remarks-content-date">
                                          ...
                                          <input name="remarks[arrival_date]" type="hidden" id="b_entryCountryTime" />
                                          <input type="hidden" id="HtlSch_checkin" required="1"/>
                           ...
                           <div id="bkg-credit-card-dv" class="bkg-credit-card-dv">
                              ...
                              <div class="htl-b-credit-card-content clearfix">
                                 ...
                                 <div class="col">
                                    ...
                                    <div class="clearfix">
                                       <div class="sub-col">
                                          <select id="cc_expiryMonth" name="payment_month" class="sel htl-b-sel" title="" required="1">
                                       ...
                                       <div class="sub-col">
                                          <select id="cc_expiryYear" name="card_year" class="sel htl-b-sel" title="" required="1">
                                 ...
                                 <div class="htl-b-special-content clearfix">
                                    ...
                                    <div>
                                       ...
                                       <div class="htl-b-special-item hidden" id="htl-b-special-item">
                                          <div class='row'>
                                             <div class='col1'><label> <input type='checkbox' value='RqNonSmokingFloor' />Non-Smoking Floors</label></div>
                                             <div class='col2'><label> <input type='checkbox' value='RqDblBed' />Double Bed</label></div>
                                             <div class='col3'><label> <input type='checkbox' value='RQEarlyCheckin' />Early Check In</label></div>
                                          </div>
                                          <div class='row'>
                                             <div class='col1'><label> <input type='checkbox' value='RQLateCheckout' />Late Check Out</label></div>
                                             <div class='col2'><label> <input type='checkbox' value='RqAdjoinningRoom' />Adjacent Room</label></div>
                                             <div class='col3'><label> <input type='checkbox' value='RqConnectingRoom' />Connect Room</label></div>
                                          </div>
                                          <div class='row'>
                                             <div class='col1'><label> <input type='checkbox' value='RqHighFloor' />High Floor Room</label></div>
                                             <div class='col2'><label> <input type='checkbox' value='RQTwin' />Two Beds</label></div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <div id="bkg-terms-out-dv">
                              <div class="htl-b-terms item-list clearfix">
                                 ...
                                 <div class="clearfix items-content bmr-terms-content">
                                    <p style="background: white"><span style=";color: black;font-size: 13px">· </span><span style=";font-family: ">Managed Quarantine Hotel Package – includes accommodation, breakfast, lunch, evening meal and hot and cold drinks, 2 Covid tests and transfer from the port of arrival to and from the hotel at the end of your quarantine. </span></p>
                                    <p style="background: white"><span style=";font-family: ">· The payment will be processed using the card provided at the time of booking for Managed Hotel Quarantine Package. Any additional charges incurred during the stay must be settled directly by the guest to the hotel on departure. If the card details provided are not accepted, you will be advised by email and will be required to rebook. </span></p>
                                    ...
                                    <p style="background: white"><span style=";font-family: ">· Unless otherwise specified, all other expenses shall be regarded as personal consumption and Corporate Travel Management (North) Ltd will not be liable for any charges incurred on your behalf. </span></p>
                                    <p style="background: white"><span style=";font-family: ">· You are required by law to complete the full quarantine at the hotel. </span></p>
                                    <p style="background: white"><span style=";font-family: ">· When you book a room it means that you have accepted the full terms and conditions of booking. </span></p>
                                    <p style="background: white"><span style=";font-family: ">· Please keep your booking confirmation and invoice (which contains your booking reference) as proof of booking and purchase. </span></p>
                                    <p style="background: white"><span style=";font-family: ">· If you do not receive your confirmed booking/invoice  please check your spam or junk email before contacting the CTM team </span></p>
                                    <p style="background: white"><span style=";font-family: ">· You must have a confirmed booking/invoice prior to travel to England, Northern Ireland and Scotland.</span></p>
                                    <p style="background: white"><span style=";font-family: "><br/></span></p>
                                    <p style="background: white">  <strong>Anyone aged under 18 years old must be accompanied by an adult aged 18 years or over during their entire hotel quarantine stay.</strong> </p>
                                    <p> <a href="https://www.gov.uk/guidance/booking-and-staying-in-a-quarantine-hotel-when-you-arrive-in-england" _src="https://www.gov.uk/guidance/booking-and-staying-in-a-quarantine-hotel-when-you-arrive-in-england">https://www.gov.uk/guidance/booking-and-staying-in-a-quarantine-hotel-when-you-arrive-in-england</a> </p>
                                    <p><br/></p>
                                    <p style="background: white"><span style=";font-family: ">· You will received the following 2 documents from CTM;</span></p>
                                    <p style="background: white"><span style=";font-family: "> <br/> 1) An email confirming that your booking request has been received and to let you know that it is being processed. This confirmation number is <strong>NOT</strong> the number you use on the PLF which will be emailed to you from:</span><span style="font-size: 16px;"><a><span style="color: rgb(0, 0, 255); font-family: Calibri; text-decoration: underline;">North.hotels@travelctm.com</span></a><span style="color: black;"> </span></span><span style=";color: black;font-size: 13px"><br/> <br/> 2</span><span style=";font-family: ">) Final Confirmation / Invoice – to let you know your booking has been accepted. You will receive your invoice once payment has been confirmed. If payment is not accepted you will be advised by email and you will need to rebook. The numerical digit number on the final confirmation/ invoice is the <strong><em>invoice number</em></strong> that <strong><em>you must use when completing your PLF form. </em></strong>If you do not have this final confirmation/ invoice you will <strong>NOT </strong>be able to complete the PLF. The Final Confirmation/Invoice will be sent to you from the following address</span><span style=";color: black;font-size: 13px">: </span><span style="font-size: 16px;"><a><span style="color: rgb(0, 0, 255); font-family: Calibri; font-size: 16px; text-decoration: underline;">donotreply@eu.travelctm.com</span></a></span> </p>
                                    <p style="background: white"><br/></p>
                                    <p align="left" style="background: white; margin: 0px; text-align: left;"><span style="margin: 0px; font-family: ">Passenger Locator Form (PLF) -You <strong>must </strong>complete this
                                       form online before you arrive in the UK</span><span style="margin: 0px; color: black; font-size: 10pt;">. </span><span style="margin: 0px;"><span style="margin: 0px; color: red; font-size: 10pt;"><span style="margin: 0px; color: red;"><a href="https://www.gov.uk/provide-journey-contact-details-before-travel-uk" _src="https://www.gov.uk/provide-journey-contact-details-before-travel-uk">https://www.gov.uk/provide-journey-contact-details-before-travel-uk</a></span></span></span>
                                    </p>
                                    <p align="left" style="background: white; margin: 0px; text-align: left;"><span style="margin: 0px;"><span style="margin: 0px; color: red; font-size: 10pt;"><span style="margin: 0px; color: red;"> </span></span></span></p>
                                    <p><br/></p>
                                 </div>
                              </div>
                           </div>
                  ...
                  <div id="bkg-verify-dv" class="htl-b-btn-dv clearfix hidden" style="display: none;">
                  <div class="bmr-booking-btns width_100p">
                  <div class="booking-rules-dv fl"><div class="terms-box"><label style="font-weight: bold;">
                  <input id="ck-recipient-promotion" type="checkbox"><label for="ck-recipient-promotion">&nbsp;<span class="color-red">*</span></label>We will only contact the customer in connection with this booking and not for marketing purposes or promotions</label></div><div class="terms-box margin_t_5px"><label style="font-weight: bold;">
                  <input type="checkbox" id="bkg-rules1"><label for="bkg-rules1"></label>&nbsp;<span class="color-red">*</span>I confirm that I have read and accepted the <a class="color-red" target="_blank" href="https://quarantinehotels.ctmportal.co.uk/Content/View.aspx?category=Terms&amp;key=general-terms-htl">booking terms</a>, website terms and disclaimer and <a class="color-red" target="_blank" href="https://investor.travelctm.com.au/privacy/">privacy policies</a>.</label></div></div>
                  ...
                  <input type="submit" value="Submit" class="htl-b-book-btn-next" />
                  </div>
                  <a href="{{url('/')}}"  class="htl-b-sch-btn history_back_mark text-center">Back<a/>
                  </div>
                  </form>
                  <div id="bkg-verify-dv" class="htl-b-btn-dv clearfix hidden">
                  <div class="bmr-booking-btns width_100p">
