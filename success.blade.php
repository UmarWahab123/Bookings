...
<body class="pkg-sch-page" lang="en-us">
    ...
    <div class="pkg-sch-page-container">
        ...
        <div id="main_container" class="htl-sch-container htl-sch-container-single htl-sch-container-bkg-result" >



    <div class="htl-sch-page-sub">

        <div class="htl-book-complete-dv">

    <div class="bees-alert-msgbox-content"></div>

    <div class="htl-book-complete-msg">

        <p>Your Manage quarantine package has been recieve and is being processed </p><br>
        <p>We have sent you an acknoledgement by e-mail from the following address:<br>North.hotels@travelctm.com Please also check your junk or spam email</p><br>
        <p>Once your booking has been processed you will recieve an invoice from<br> donotreply@eutravelctm.com 48 hours prior to your departure into the UK</p><br>
        <p>You will need the reference number when completing your Passenger Locater<br> From(PLF) before departure https://www.gov.uk-provide-journey-contact-details-before-travel-uk</p><br>
        <p>Click here for more information about your travel and quarantine at home<br> https://www.gov.uk/guidance/how-to-quarantine-when-you-arrive-in-england</p><br>
        <p>Please contact CTM if you need any helf or assistance at +44 (0) 207 429 9732<br> Email-quarantine.hotels@travelctm.com</p>

                <div class="htl-book-complete-sch">

            <a href="{{url('/')}}" class="pointer color-white">Return to Home Page</a>
...
<div id="abovefooter">
    ...
    <input id="__RequestVerificationToken" name="__RequestVerificationToken" type="hidden" value="tuS33x9RNHSorlLa/vIcsWoK1lAB6yOIgooWu8M2Y6RrmJ+S9EvRQVVCgOFXvnYl" />
