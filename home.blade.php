...
<body>
    ...
    <img src="/public/frontend/images/banner_1_2.jpg"/>
    ...
    <div class="htl-sch-form-bd">
        ...
        <div class="row clearfix" class="checkIn-from">
            ...
            <div class="htl-sch-item sm">
                ...
                <div class="htl-sch-txt-bg passengerdiv">
...
<div class="dv-age-item age1"><span class="span-age-title">Child 1</span><span class="span-age-sel"><select id="age_0" name="age_0" class="sel sch-sel-small" title="" required="1"><option value="-1" selected="selected">-?-</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option></select></span></div><div class="dv-age-item age2"><span class="span-age-title">Child 2</span><span class="span-age-sel"><select id="age_1" name="age_1" class="sel sch-sel-small" title="" required="1"><option value="-1" selected="selected">-?-</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option></select></span></div>
